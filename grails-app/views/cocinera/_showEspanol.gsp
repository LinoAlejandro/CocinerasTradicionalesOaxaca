...
<html>
  ...
  <body>
            ...
            <div class="row justify-content-center align-items-center">
              <g:each var="platillo" in="${platillos}">
                ...
                <div class="col-md-7">
                  ...
                  <div class="my-3">
                    <span class="text-muted">Tipo de platillo:</span> <span>${platillo.tipoPlatillo == 'cotidiano' ? 'Cotidiano':'Ceremonial'}</span>
                    <div class="">
                      <span class="text-muted">Número de convocatoria:</span> <span>${platillo.convocatoria}</span>
                    </div>
                    <div class="">
                      <span class="text-muted">Premio:</span> <span>${platillo.premio}</span>
                    </div>
                  </div>
                  <div class="">
                    <span class="h5 mb-2">Ingredientes:</span>
                    ${raw(platillo.ingredientes)}
                  </div>
                  <g:if test="${platillo.premio}">
                    <div class="">
                      <span class="text-info">*Este platillo ha ganado en la siguiente categoría:</span>
                      ${platillo.premio}
                    </div>
                  </g:if>
                </div>
    ...
    <div class="container mt-3">
      <div class="row">
        <a href="https://www.facebook.com/sharer/sharer.php?u=${request.getRequestURL().replaceAll(':','%3A').replaceAll('/','%2F')}1&amp;src=sdkpreparse" target="_blank" class="btn btn-primary">
