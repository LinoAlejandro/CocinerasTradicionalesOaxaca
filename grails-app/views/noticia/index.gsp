            ...
            <tbody>
              <g:each var="noticia" in="${noticias}">
                <tr id="${noticia.id}">
                  ...
                  <td>
                    <g:link class="btn btn-outline-primary btn-sm" action="update" id="${noticia.id}">Modificar</g:link>
                  </td>
                  <td>
                    <g:link class="btn btn-outline-danger btn-sm" action="delete" id="${noticia.id}" params="${params}">Eliminar</g:link>
                  </td>
                  <td> 
