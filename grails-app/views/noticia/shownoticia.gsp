...
<html>
  <head>
    ...
    <asset:stylesheet href="custom/noticia/showNoticia.css"/>
    ...
    <div class="container-fluid">
      <g:if test="${mediaFotos.size() > 0}">
        <div class="row px-5 pb-2 align-items-center" data-aos="zoom-out-right">
          ...
          <div class="col-md-2 text-red lobster h1 text-center mt-4">
            Imágenes
          </div>
          <div class="col-md-5">
            <hr class="style">
          ...
          <g:if test="${mediaVideo.size() > 0}">
            <div class="row px-5 pb-2 align-items-center" data-aos="zoom-out-left">
              ...
              <div class="col-md-2 text-red lobster h1 text-center pt-4">
                Videos
              </div>
              <div class="col-md-5">
                <hr class="style">
          ...
          <g:if test="${sugerencias.size() > 0}">
            <div class="row px-5 pt-2 pb-4">
              <div class="col-md-12">
                <div class="lobster h2 text-red mb-3">
                ...
                <div class="row justify-content-center">
                  ...
                  <div class="col-md-3">
                    <a href="${createLink(action:'show', id:sugerencia.id)}">
                      <div class="p-2 border-red">
                        <img src="${sugerencia.ubicacionImagen}" alt="" class="img img-fluid img-responsive">
                        <div class="cabin text-center text-red">
                          ${sugerencia.traduccionEspanol.titulo}
                        </div>
                      </div>
                    </a>
                  </div>
